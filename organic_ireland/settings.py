"""
Django settings for organic_ireland project.
...
SECRET_KEY = 'django-insecure-+774ruvzhtc5q1y4*&!ly2a*b4k^y+tb^vd%dxo_563=&j=^57'
...
ROOT_URLCONF = 'organic_ireland.urls'
...
ACCOUNT_EMAIL_VERIFICATION = 'mandatory'  # Optional email verification
...
LOGIN_URL = '/accounts/login/'  # URL to redirect to after login
LOGIN_REDIRECT_URL = '/'  # URL to redirect to after login

WSGI_APPLICATION = 'organic_ireland.wsgi.application'
